...
import numpy as np
#Ekrana datasetimizi yani sayıların resimlerini yazdırmak için numpy kütüphanesini ekledik.
...
#Resmi yazdırmak için yazılan fonksiyonumuz.
...
# Yapılan yanlış tahminleri grafiğe çekiyoruz.
